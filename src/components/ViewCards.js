       ...
       <div className="bg-white rounded-lg shadow-lg p-4 sm:p-8">
         ...
         <div className="mb-4 sm:mb-6">
           <div className="relative max-w-2xl mx-auto">
             ...
             <input
               ...
               className="w-full pl-10 pr-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 text-sm sm:text-base"
             />
           </div>
         </div>
         ...
         {(searchTerm || filterSport || filterYearStart || filterYearEnd || filterManufacturer || filterSet || filterGradingCompanies.length > 0 || filterGradeRange || filterHasImage) && (
           <div className="mb-4 sm:mb-6">
             <div className="flex flex-wrap gap-2 justify-center">
               ...
               {filterSet && (
                 <span className="inline-flex items-center px-2 sm:px-3 py-1 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800">
                   Set: {filterSet}
                   <button
         ...
         <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
           ...
           <div className="w-full lg:w-80 lg:flex-shrink-0">
             <div className="bg-gray-50 rounded-lg p-4 sm:p-6 lg:sticky lg:top-6">
               ...
               <div className="space-y-4">
                 ...
                 <div>
                   ...
                   <select 
                     ...
                     className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 text-sm"
                   >
             ...
             <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
               ...
               <div className="flex items-center space-x-2">
                 ...
                 <button
                   ...
                   className={`px-2 sm:px-3 py-2 rounded-lg font-medium transition duration-200 text-xs sm:text-sm ${
                     viewMode === 'grid' 
           ...
           {sortedCards.length === 0 ? (
             <div className="text-center py-8 sm:py-12">
               ...
               <p className="text-gray-600 text-base sm:text-lg">No cards found. Add your first card!</p>
             </div>
           ) : (
             <div className={`
               ${viewMode === 'grid' ? 'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6' : ''}
               ${viewMode === 'compact' ? 'grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2 sm:gap-3' : ''}
             ...
             `}>
               {sortedCards.map((card) => (
                 <div 
                   key={card.id} 
                   className={`
                     ${viewMode === 'grid' ? 'bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-lg transition duration-200 p-4 sm:p-6' : ''}
                     ${viewMode === 'compact' ? 'bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition duration-200 p-2 sm:p-3 cursor-pointer' : ''}
                     ${viewMode === 'list' ? 'bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition duration-200 p-3 sm:p-4 flex justify-between items-center cursor-pointer' : ''}
                   `}
                   ...
                   {viewMode === 'grid' && (
                     <>
                       ...
                       <div className="mb-3 sm:mb-4 flex justify-center">
                         ...
                         {!card.imageUrl && (
                           <CardImagePlaceholder className="w-full h-32 sm:h-48 rounded-lg">
                             <div className="text-center">
                       ...
                       <div className="mb-2">
                         {card.imageUrl ? (
                           <img
                             src={card.imageUrl}
                             alt={`${card.player} card`}
                             className="w-full h-16 sm:h-24 object-cover rounded border border-gray-200"
                             onError={(e) => {
                               e.target.style.display = 'none';
                               e.target.nextSibling.style.display = 'flex';
                             }}
                         ...
                         {!card.imageUrl && (
                           <CardImagePlaceholder className="w-full h-16 sm:h-24 rounded">
                             <div className="text-center">
                               <svg className="w-4 h-4 sm:w-6 sm:h-6 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                               </svg>
                             </div>
                           </CardImagePlaceholder>
                   ...
                   {viewMode === 'list' && (
                     <>
                       <div className="flex items-center space-x-3 sm:space-x-4 flex-1">
                         ...
                         <div className="flex-shrink-0">
                           {card.imageUrl ? (
                             <img
                               src={card.imageUrl}
                               alt={`${card.player} card`}
                               className="w-12 h-16 sm:w-16 sm:h-20 object-cover rounded border border-gray-200"
                               onError={(e) => {
                                 e.target.style.display = 'none';
                                 e.target.nextSibling.style.display = 'flex';
                               }}
                           ...
                           {!card.imageUrl && (
                             <CardImagePlaceholder className="w-12 h-16 sm:w-16 sm:h-20 rounded">
                               <div className="text-center">
                                 <svg className="w-4 h-4 sm:w-6 sm:h-6 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                 </svg>
                         ...
                         <div className="flex-1">
                           <h4 className="font-semibold text-gray-900 text-sm sm:text-base">{card.player}</h4>
                           <p className="text-xs sm:text-sm text-gray-600">{card.year} {card.manufacturer} - {card.sport}</p>
                         </div>
                       </div>
                       <div className="flex items-center space-x-2">
                         <button
